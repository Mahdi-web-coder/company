(function($) {
	...
	if($('.Product-tab').length){
		$('.Product-tab .tab-btns .tab-btn').on('click', function(e) {
			e.preventDefault();
			var target = $($(this).attr('data-tab'));
			...
			if ($(target).hasClass('actve-tab')){
				...
				$('.Product-tab .tab-btns .tab-btn').removeClass('active-btn');
				$(this).addClass('active-btn');
				$('.Product-tab .tabs-content .tab').removeClass('active-tab');
